...
public class Global {
	...
	public static Hashtable<String, String[]> EXON_LENGTH_HASH = new Hashtable<String, String[]>();
	public static Hashtable<String, String[]> PERCENT_FULL_DIST_HASH = new Hashtable<String, String[]>();
	public static Hashtable<String, String[]> PERCENT_EXON_DIST_HASH = new Hashtable<String, String[]>();
	public static Hashtable<String, String[]> PERCENT_CDS_DIST_HASH = new Hashtable<String, String[]>();
	public static Hashtable<String, String[]> FROM_START_DIST_HASH = new Hashtable<String, String[]>();
	public static Hashtable<String, String[]> FROM_STOP_DIST_HASH = new Hashtable<String, String[]>();
	//public static String[] SEQUENCE_ARRAY;
	
	public static void putExonLengths (String key, String[] exonLengths, boolean enforce) {
		if(EXON_LENGTH_HASH.get(key) == null || enforce) EXON_LENGTH_HASH.put(key, exonLengths);
	}
	public static void putPercentFullDist (String key, String[] pFullDist, boolean enforce) {
		if(PERCENT_FULL_DIST_HASH.get(key) == null || enforce) PERCENT_FULL_DIST_HASH.put(key, pFullDist);
	}
	public static void putPercentExonDist (String key, String[] pExonDist, boolean enforce) {
		if(PERCENT_EXON_DIST_HASH.get(key) == null || enforce) PERCENT_EXON_DIST_HASH.put(key, pExonDist);
	}
	public static void putPercentCDSDist (String key, String[] pCDSDist, boolean enforce) {
		if(PERCENT_CDS_DIST_HASH.get(key) == null || enforce) PERCENT_CDS_DIST_HASH.put(key, pCDSDist);
	}
	public static void putStartDist (String key, String[] startDist, boolean enforce) {
		if(FROM_START_DIST_HASH.get(key) == null || enforce) FROM_START_DIST_HASH.put(key, startDist);
	}
	public static void putStopDist (String key, String[] stopDist, boolean enforce) {
		if(FROM_STOP_DIST_HASH.get(key) == null || enforce) FROM_STOP_DIST_HASH.put(key, stopDist);
	}
