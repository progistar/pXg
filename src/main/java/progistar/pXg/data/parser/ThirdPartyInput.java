	...
	public static void main(String[] args) throws IOException {
		...
		*/
		...
		for(int idx = 0; idx < pxgList.length; idx++) {
			...
			Hashtable<String, String> prositInput = new Hashtable<>();
			Hashtable<String, String> deepLCInput = new Hashtable<>();
			Hashtable<String, String> deepLCInputCal = new Hashtable<>();
			Hashtable<String, Double> isBestScore = new Hashtable<>();
			Hashtable<String, String> netmhcpanInput = new Hashtable<>();
