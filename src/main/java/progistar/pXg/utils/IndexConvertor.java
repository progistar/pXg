...
public class IndexConvertor {
	...
	private static Hashtable<String, Integer> strToIndex = new Hashtable<>();
	private static Hashtable<Integer, String> indexToStr = new Hashtable<>();
