...
public class _HighScoreDecoy2 {
	...
	public static void percolatorAnalysis () throws IOException {
		...
		BufferedWriter BWAll = new BufferedWriter(new FileWriter("/Users/gistar/eclipse-workspace/pXg/test/high_score_decoy/nocut_features_rank/_all."+feat+".BA"));
		...
		for(int i=0; i<sampleListTarget.length; i++) {
			...
			BufferedWriter BW = new BufferedWriter(new FileWriter("/Users/gistar/eclipse-workspace/pXg/test/high_score_decoy/nocut_features_rank/"+outList[i]));
			
			BufferedReader BR = new BufferedReader(new FileReader("/Users/gistar/eclipse-workspace/pXg/test/high_score_decoy/nocut_features_rank/"+sampleListTarget[i]));
			...
			BR.close();
			// for decoy
			BR = new BufferedReader(new FileReader("/Users/gistar/eclipse-workspace/pXg/test/high_score_decoy/nocut_features_rank/"+sampleListDecoy[i]));
			BR.readLine(); // skip header
			while((line = BR.readLine()) != null) {
				String[] fields = line.split("\t");
				String psmId = fields[0];
			...
			BR = new BufferedReader(new FileReader("/Users/gistar/eclipse-workspace/pXg/test/high_score_decoy/nocut_features_rank/"+pxgList[i].split("\\.")[0]+"."+feat+".pin"));
			...
			String header = BR.readLine()+"\tSA\tBestDeltaRT\tpercolator_score\tq-value\tpep\tEL_Rank\tBestHLAType\tSample\tIsSelectedTarget";
			BW.append(header);
			BW.newLine();
			...
			Hashtable<String,String> surviveMapper = parseXML("/Users/gistar/eclipse-workspace/pXg/test/high_score_decoy/nocut_features_rank/"+sampleListTargetXML[i]);
