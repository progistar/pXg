...
public class NetMHCconsParser {
	
	public static NetMHCconsResult parseNetMHCcons (String fileName) {
		
		NetMHCconsResult result = new NetMHCconsResult();
		...
		try {
			...
			int peptideIndex = 1;
			int elRankBaseIndex = 4;
			int elRankIndexInteravl = 3;
			...
			while((line = BR.readLine()) != null) {
				...
				NetMHCconsData data = new NetMHCconsData();
