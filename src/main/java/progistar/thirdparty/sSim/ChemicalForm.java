...
public class ChemicalForm {
	...
	public String toString() {
		...
		if(this.C > 0) formula.append("C").append("(").append(this.C).append(")");
		if(this.H > 0) formula.append("H").append("(").append(this.H).append(")");
		if(this.O > 0) formula.append("O").append("(").append(this.O).append(")");
		if(this.N > 0) formula.append("N").append("(").append(this.N).append(")");
		if(this.S > 0) formula.append("S").append("(").append(this.S).append(")");
		if(this.P > 0) formula.append("P").append("(").append(this.P).append(")");
		if(this.Na > 0) formula.append("Na").append("(").append(this.Na).append(")");
		if(this.Se > 0) formula.append("Se").append("(").append(this.Se).append(")");
		if(this.Fe > 0) formula.append("Fe").append("(").append(this.Fe).append(")");
		if(this.K > 0) formula.append("K").append("(").append(this.K).append(")");
		if(this.I > 0) formula.append("I").append("(").append(this.I).append(")");
