...
public class Modification {
	...
	public static ArrayList<Modification> getModificationsByModIdentifier (String modIdentifier) {
		if(preDefinedModificationList == null) {
			preDefinedModificationList = new Hashtable<String, ArrayList<Modification>>();
			massByModName = new Hashtable<String, String>();
			initModification();
		}
	...
	public static void addModification (Modification mod) {
		...
		if(mods == null) mods = new ArrayList<Modification>();
		mods.add(mod);
	...
	public double getModMass () {
		if(getChemicalForm() != null) return getChemicalForm().getMass();
		else return Double.parseDouble(this.modMass);
	}
